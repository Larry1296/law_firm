...
urlpatterns = [
    ...
    path("<uuid:client_id>/conflict-checks/<uuid:check_id>/documents/", ProposedMatterDocumentsView.as_view(), name="admin-proposed-matter-documents"),
    path("<uuid:client_id>/conflict-checks/<uuid:check_id>/documents/<uuid:reference_id>/", ProposedMatterDocumentReferenceDetailView.as_view(), name="admin-proposed-matter-document-detail"),
