...
from apps.clients.views.admin.individual_admin_create_client_view import (
    build_individual_create_response,
)
...
class SecretaryClientsView(SecretaryBaseView):
    ...
    def post(self, request, client_type=None):
        ...
        if model_client_type == Client.ClientType.INDIVIDUAL:
            response = build_individual_create_response(result)
